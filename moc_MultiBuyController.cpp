...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_MultiBuyController_t, stringdata0) + ofs \
...
void MultiBuyController::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<MultiBuyController *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject MultiBuyController::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_MultiBuyController.data,
    qt_meta_data_MultiBuyController,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *MultiBuyController::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_MultiBuyController.stringdata0))
